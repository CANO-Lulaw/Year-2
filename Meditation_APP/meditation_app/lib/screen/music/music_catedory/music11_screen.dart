...
class Music11Screen extends StatefulWidget {
  const Music11Screen({super.key});

  @override
  State<Music11Screen> createState() => _Music11ScreenState();
}

class _Music11ScreenState extends State<Music11Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music11.mp3");
  ...
  Widget circularAudioPlayer(double screenWidth) {
    Color primaryColor = const Color.fromARGB(255, 163, 198, 196);
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          "Waterfall",
          style: TextStyle(
            color: Color.fromRGBO(200, 241, 235, 1),
            fontSize: 50,
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music11.jpg"),
                  fit: BoxFit.cover),
            ),
