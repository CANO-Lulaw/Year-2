...
class Music6Screen extends StatefulWidget {
  const Music6Screen({super.key});

  @override
  State<Music6Screen> createState() => _Music6ScreenState();
}

class _Music6ScreenState extends State<Music6Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music6.mp3");
  ...
  Widget circularAudioPlayer(double screenWidth) {
    Color primaryColor = const Color.fromARGB(255, 45, 83, 81);
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music6.jpg"),
                  fit: BoxFit.cover),
            ),
