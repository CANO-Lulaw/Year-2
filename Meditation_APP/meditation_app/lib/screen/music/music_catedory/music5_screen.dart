...
class Music5Screen extends StatefulWidget {
  const Music5Screen({super.key});

  @override
  State<Music5Screen> createState() => _Music5ScreenState();
}

class _Music5ScreenState extends State<Music5Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music5.mp3");
  ...
  Widget circularAudioPlayer(double screenWidth) {
    Color primaryColor = const Color.fromARGB(255, 61, 168, 162);
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music5.jpg"),
                  fit: BoxFit.cover),
            ),
