...
class Music12Screen extends StatefulWidget {
  const Music12Screen({super.key});

  @override
  State<Music12Screen> createState() => _Music12ScreenState();
}

class _Music12ScreenState extends State<Music12Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music12.mp3");
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music1.jpg"),
                  fit: BoxFit.cover),
            ),
