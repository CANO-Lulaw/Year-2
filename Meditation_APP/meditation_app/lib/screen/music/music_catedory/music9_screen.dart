...
class Music9Screen extends StatefulWidget {
  const Music9Screen({super.key});

  @override
  State<Music9Screen> createState() => _Music9ScreenState();
}

class _Music9ScreenState extends State<Music9Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music9.mp3");
  ...
  Widget circularAudioPlayer(double screenWidth) {
    Color primaryColor = const Color.fromARGB(255, 8, 18, 18);
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music9.jpg"),
                  fit: BoxFit.cover),
            ),
