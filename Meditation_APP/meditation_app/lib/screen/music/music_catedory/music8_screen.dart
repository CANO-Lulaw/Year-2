...
class Music8Screen extends StatefulWidget {
  const Music8Screen({super.key});

  @override
  State<Music8Screen> createState() => _Music8ScreenState();
}

class _Music8ScreenState extends State<Music8Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music8.mp3");
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music8.jpg"),
                  fit: BoxFit.cover),
            ),
