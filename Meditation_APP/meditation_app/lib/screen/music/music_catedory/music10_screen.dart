...
class Music10Screen extends StatefulWidget {
  const Music10Screen({super.key});

  @override
  State<Music10Screen> createState() => _Music10ScreenState();
}

class _Music10ScreenState extends State<Music10Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music10.mp3");
  ...
  Widget circularAudioPlayer(double screenWidth) {
    Color primaryColor = const Color.fromARGB(255, 181, 221, 219);
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music10.jpg"),
                  fit: BoxFit.cover),
            ),
