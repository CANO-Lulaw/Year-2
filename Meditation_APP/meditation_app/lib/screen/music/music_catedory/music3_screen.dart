...
class Music3Screen extends StatefulWidget {
  const Music3Screen({super.key});

  @override
  State<Music3Screen> createState() => _Music3ScreenState();
}

class _Music3ScreenState extends State<Music3Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music3.mp3");
  ...
  Widget circularAudioPlayer(double screenWidth) {
    Color primaryColor = const Color.fromARGB(255, 129, 193, 190);
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music3.jpg"),
                  fit: BoxFit.cover),
            ),
