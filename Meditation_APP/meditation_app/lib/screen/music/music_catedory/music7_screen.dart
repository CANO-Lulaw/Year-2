...
class Music7Screen extends StatefulWidget {
  const Music7Screen({super.key});

  @override
  State<Music7Screen> createState() => _Music7ScreenState();
}

class _Music7ScreenState extends State<Music7Screen> {
  ...
  void setupPlaylist() async {
    await audioPlayer.setAsset("assets/music/music7.mp3");
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/music7.jpg"),
                  fit: BoxFit.cover),
            ),
