        ...
        if direct == 'B' or direct is None :
            ...
            if currnt.data == start:
                ...
                while currnt.prev.data != end:
                    ...
                    route2.append(currnt.data)
                    count2 += 1
                route2.append(currnt.prev.data)
...
inp = [i.split(',') for i in input("Input Station name/Source, Destination, Direction(optional): ").split('/')]
for i in inp[0]:
    L.append(i)
L.tocircle()
